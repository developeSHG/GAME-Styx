...
Engine::CTriCol::CTriCol(LPDIRECT3DDEVICE9 _pGraphicDev)
...
Engine::CTriCol* Engine::CTriCol::Create(LPDIRECT3DDEVICE9 _pGraphicDev)
{
	CTriCol*	pInstance = new CTriCol(_pGraphicDev);
