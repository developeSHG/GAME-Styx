...
CMpBar::CMpBar(LPDIRECT3DDEVICE9 _pGraphicDev)
...
HRESULT CMpBar::Ready_Object(void)
{
...
_int CMpBar::Update_Object(const _float& fTimeDelta)
{
...
_int CMpBar::LateUpdate_Object(const _float& fTimeDelta)
{
...
void CMpBar::PreRender_Object(void)
{
	m_pGraphicDev->SetTransform(D3DTS_WORLD, &m_pTransCom->m_matWorld);
}

void CMpBar::Render_Object(void)
{
	PreRender_Object();
...
void CMpBar::PostRender_Object(void)
{
...
CMpBar* CMpBar::Create(LPDIRECT3DDEVICE9 _pGraphicDev)
{
	CMpBar*	pInstance = new CMpBar(_pGraphicDev);
