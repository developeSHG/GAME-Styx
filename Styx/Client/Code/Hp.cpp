...
CHp::CHp(LPDIRECT3DDEVICE9 _pGraphicDev)
...
_int CHp::Update_Object(const _float& fTimeDelta)
{
...
_int CHp::LateUpdate_Object(const _float& fTimeDelta)
{
...
void CHp::PreRender_Object(void)
{
...
void CHp::PostRender_Object(void)
{
...
CHp* CHp::Create(LPDIRECT3DDEVICE9 _pGraphicDev)
{
	CHp*	pInstance = new CHp(_pGraphicDev);
