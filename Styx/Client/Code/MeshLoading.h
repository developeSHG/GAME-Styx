#ifndef MeshLoading_h__
#define MeshLoading_h__
...
class CMeshLoading : public Engine::CGameObject
{
private:
	explicit CMeshLoading(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CMeshLoading(void);
...
public:
	static CMeshLoading*				Create(LPDIRECT3DDEVICE9 pGraphicDev);
private:
