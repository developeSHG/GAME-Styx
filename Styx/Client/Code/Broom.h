...
class CBroom : public Engine::CGameObject
{
public:
...
private:
	/*  Structor  */
	explicit CBroom(LPDIRECT3DDEVICE9 _pGraphicDev);
	virtual ~CBroom(void);
...
public:
	static CBroom*				Create(LPDIRECT3DDEVICE9 _pGraphicDev, CElite* _pElite);
private:
